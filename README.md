# GlassJaw
**The Vulnerable API Service** *(Based on OpenAPI 3)*
Based on ![vampi](https://github.com/erev0s/VAmPI)

## Intro
GlassJaw is based on the code of VAmPI - a vulnerable API made with Flask and it includes vulnerabilities from the OWASP top 10 vulnerabilities for APIs. 
GlasJaw aims to provide a more complex challenge than the original code and to expand to different scenarios of exploitation. 
